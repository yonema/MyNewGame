...
namespace nsMyGame
{
	...
	*/
	namespace nsGeometry
	{
        ...
        void CBSP::WalkTree(SEntityPtr entityPtr, const Vector3& pos, std::function<void(SLeaf* leaf)> onEndWalk)
        {
        ...
        void CBSP::WalkTree(const Vector3& pos, std::function<void(SLeaf* leaf)> onEndWalk)
        {
